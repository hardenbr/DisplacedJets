...
config.General.requestName = 'XX4J_CENTRAL_OCT5'
config.General.workArea = 'CRAB3_XX4J_CENTRAL_OCT5'
...
config.Data.outLFNDirBase = '/store/group/phys_susy/razor/josh/RAZOR_DIJET/DJANALYSIS/XX4J_CENTRAL_ANGLE'
