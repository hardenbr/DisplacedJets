...
vertexCutsBlock = cms.PSet(
	vertexCuts = cms.PSet(
		...
		maxDeltaRToJetAxis = cms.double(2.0), #displaced .5 -> 1.0
		v0Filter = cms.PSet(k0sMassWindow = cms.double(-9999999)), #k short filter out? displaced .05 --> -infty
