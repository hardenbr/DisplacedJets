...
process.trackIPsFromJetTracks = cms.EDProducer( "TrackIPProducer",
    maximumTransverseImpactParameter = cms.double( 999999 ),
    minimumNumberOfHits = cms.int32( 4 ),
    minimumTransverseMomentum = cms.double( 1.0 ),
    primaryVertex =  cms.InputTag( "offlinePrimaryVerticies","","RECO" ),
    maximumLongitudinalImpactParameter = cms.double( 999999 ),
...
#run the anlayzer
process.p = cms.Path(process.trackIPsFromJetTracks + process.analyzer)
