...
if isSignalMC:
    process.analyzerVTX.outputFileName = cms.untracked.string('signalVTX.root')
    process.analyzerCALO.outputFileName = cms.untracked.string('signalCALO.root')

else:
    process.analyzerVTX.outputFileName = cms.untracked.string('qcdVTX.root')
    process.analyzerCALO.outputFileName = cms.untracked.string('qcdCALO.root')
